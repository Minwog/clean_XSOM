...
*/
  ...
  display()  += ccmpl::dots("color='r', s = 5",         std::bind(fill_map_dots, std::ref(map1), std::ref(map2), _1)); flags += "#";
  ...
  display()  += ccmpl::dots("color='r', s = 5",         std::bind(fill_map_2_dots, std::ref(map1), std::ref(map2), _1)); flags += "#";
